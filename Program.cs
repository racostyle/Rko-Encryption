...
namespace Rko_encription
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var simpleEncryption = new EncryptionDecorator(encrFactory.Create(EncryptionType.Classic));
            var doubleEncryption = new EncryptionDecorator(encrFactory.Create(EncryptionType.Double));
            var doubleWkeyEncryption = new EncryptionDecorator(encrFactory.Create(EncryptionType.DoubleWKey));
